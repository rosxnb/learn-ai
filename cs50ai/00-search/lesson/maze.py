...
class Maze:
    def __init__(self, filename):
        ...
        map = map.splitlines()
        self.height = len(map)
        self.width = max(len(row) for row in map)
    ...
    def solve(self):
        ...
        # prepare initial state and initialize the frontier
        ...
        while True:
            ...
            # add neighbours of current node to frontier
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.exit("Useage: python maze.py map.txt")
